...
{
    [CustomEditor(typeof(PoolScrollRect), true)]
    ...
    /// </summary>
    public class PoolScrollRectEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            serializedObject.FindProperty("m_Horizontal").boolValue = !m_Vertical.boolValue;
